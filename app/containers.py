...
def health(drucker):
    ...
    print(
        colorful.white_on_blue(
            "Checking services for %s container..." % (drucker.vars.MIRROR_CONTAINER)
        )
    )
    ...
    print(
        colorful.white_on_blue(
            "Checking services for %s container..." % (drucker.vars.EDGE_CONTAINER)
        )
    )
    ...
    print(
        colorful.white_on_blue(
            "Checking services for %s container..." % (drucker.vars.DB_CONTAINER)
        )
    )
    ...
    print(
        colorful.white_on_blue(
            "Checking services for %s container..." % (drucker.vars.SEARCH_CONTAINER)
        )
    )
    ...
    print(
        colorful.white_on_blue(
            "Checking services for %s container..." % (drucker.vars.WEB_CONTAINER)
        )
    )
